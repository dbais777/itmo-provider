<template>
    <svg width="202px" height="202px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <g id="SVGRepo_iconCarrier">
        <path
            ...
            stroke="#fff" stroke-width="1.488" stroke-linecap="round" stroke-linejoin="round"></path>
    </g>
</svg></template>